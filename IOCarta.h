...
void Map::Second()
{
    ...
    if(time%10<5)
        ...
        d=2;
    int B[10][10]= {{4,3,4,3,3,4,3,4,4,4},
                    {4,7,3,0,d,0,3,0,3,3},
                    {3,0,3,0,3,0,3,0,0,3},
                    {4,0,d,0,4,0,3,4,d,4},
                    {4,0,4,d,3,d,0,0,0,4},
...
void Map::Draw()
{
    ...
    for(i=0; i<10; i++)
        for(j=0; j<10; j++)
        {
            ...
            {
                Win32::TransparentBlt (txDC(), 0+s*j, 0+s*i, s, s, DC, x*9, x, x, x, color);
                Win32::TransparentBlt (txDC(), 0+s*j, 0+s*i, s, s, DC, x*10, 0, x, x*2, color);
            }
            if(A[i][j]==7)
            {
                Win32::TransparentBlt (txDC(), 0+s*j, 0+s*i, s, s, DC, 0, 0, x*3, x*3, color);
                Win32::TransparentBlt (txDC(), 0+s*j, 0+s*i, 35, 45, NPC, 185, 0, s, 71, col);
            }
            if(A[i][j]==8)
            {
                Win32::TransparentBlt (txDC(), 0+s*j, 0+s*i, s, s, DC, 0, 0, x*3, x*3, color);
